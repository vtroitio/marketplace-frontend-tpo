...
export function Cart() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 bg-natural text-secondary">
      ...
      {cartError ? (
        <div className="w-full py-12 border text-primary border-dashed border-tertiary flex flex-col items-center justify-center text-center min-h-50">
          <div>
            <p>Ocurrió un error al cargar tu carrito.</p>
          </div>
        </div>
      ) : (
            ...
            <div className="border border-tertiary p-8 bg-natural min-w-[320px]">
              ...
              <div className="flex flex-col gap-4 items-center w-full">
                <Button
                  ...
                  disabled={
                    authLoading || cartLoading || cartItems.length === 0
                  }
                >
                  Finalizar Pedido
                </Button>
