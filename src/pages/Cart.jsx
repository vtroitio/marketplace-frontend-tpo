  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 bg-white text-black font-sans">
      ...
      <div className="flex justify-between items-baseline border-b border-black pb-3 mb-12">
        <h1 className="text-4xl font-bold uppercase tracking-tight">Tu Compra</h1>
        ...
        <div className="lg:col-span-2">
          {cartItems.length === 0 ? (
            <div className="text-center py-12 border border-dashed border-gray-300">
              <p className="text-gray-400 uppercase text-xs tracking-wider">Tu carrito está vacío.</p>
              <AppLink variant="underline" to="/home" className="text-xs font-bold uppercase mt-4 inline-block">
                Volver a la tienda
              </AppLink>
            </div>
          ) : (
            cartItems.map((item, index) => (
              ...
              >
                <div className="flex items-center gap-6">
                  ...
                  <div>
                    <h3 className="font-bold text-base uppercase tracking-wider">{item.name}</h3>
                    <p className="text-xs text-gray-400 uppercase tracking-widest mt-1">
                      Talla: {item.size} <span className="mx-2">|</span> Color: {item.color}
                    </p>
                  </div>
                </div>
        ...
        {cartItems.length > 0 && (
          <div className="border border-gray-400 p-8 bg-white min-w-[320px]">
            ...
            <div className="flex flex-col gap-4 items-center">
              <AppLink to="/checkout" className="w-full">
              ...
              <AppLink variant="underline" to="/home" className="text-xs font-bold uppercase tracking-widest text-black mt-2">
                Continuar Comprando
              </AppLink>
            </div>
          </div>
